...
INSERT INTO `estimation` VALUES (0000000001,95,90,'2014-06-06','2014-07-06','2014-07-06'),(0000000003,NULL,10,'2014-06-06','2014-10-09','2014-11-10'),(0000000041,NULL,23,'1992-04-05',NULL,'1992-05-05');
...
CREATE TABLE `project` (
  ...
  PRIMARY KEY (`proj_id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='Table to store project data ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `project` VALUES (0000000001,'testproject 1','this project is the first project with everything set up accordingly...'),(0000000002,'testproject2','this project does that'),(0000000042,'newtest','newtest');
...
INSERT INTO `project_estimation` VALUES (0000000001,0000000001),(0000000002,0000000002),(0000000003,0000000003),(0000000042,0000000041);
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `staff` (
  `STAFF_ID` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT COMMENT 'The identifier for each staff member',
...
INSERT INTO `staff_task` VALUES (0000000015,0000000002),(0000000001,0000000002);
...
INSERT INTO `task` VALUES (0000000002,0000000001,'In Progress','test task 3',NULL,'a description'),(0000000003,0000000001,'Not Started','test task 4','www.testdetails.com',NULL),(0000000005,0000000002,'Finished','finsihed test proj',NULL,'description');
...
INSERT INTO `task_dependency` VALUES (0000000002,0000000002),(0000000003,0000000003),(0000000005,0000000006),(0000000005,0000000020);
...
INSERT INTO `task_estimation` VALUES (0000000003,0000000003),(0000000006,0000000000);
...
INSERT INTO `user_project` VALUES ('testuser1',0000000001),('testuser2',0000000002),('testuser1',0000000042);
...
-- Dump completed on 2014-04-09 10:38:17
