...
INSERT INTO `account` VALUES ('testuser1','2014-02-13 12:56:15','testuser1','test1','user','testuser1@aston'),('testuser2','2014-03-02 18:06:51','testuser2','test','user2','testuse2@hotmail.com'),('testuser3','2014-03-06 22:26:29','testuser3','testuser3','testuser3','testuser1@asda');
...
--
-- Table structure for table `task_estimaton`
--

DROP TABLE IF EXISTS `task_estimaton`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `task_estimaton` (
...
--
-- Dumping data for table `task_estimaton`
--

LOCK TABLES `task_estimaton` WRITE;
/*!40000 ALTER TABLE `task_estimaton` DISABLE KEYS */;
/*!40000 ALTER TABLE `task_estimaton` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `user_project` VALUES ('testuser1',0000000001),('testuser2',0000000002);
...
-- Dump completed on 2014-03-09 11:52:34
